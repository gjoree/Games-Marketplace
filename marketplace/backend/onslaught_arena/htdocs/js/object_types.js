;(function defne_horde_objectTypes() {
  ...
  function getStatValue(statName, level) {
    const config = UPGRADE_CONFIG[statName]
    if (!config) throw new Error(`Unknown stat: ${statName}`)

    const { base, increment, maxLevel } = config

    const clampedLevel = Math.min(level, maxLevel)
    return base + (clampedLevel - 1) * increment
  }
  ...
  const UPGRADE_CONFIG = {
    hero_health: {
      base: 50,
      increment: 10,
      maxLevel: 6, // level 1 to 8 → 80 to 150
    },
    hero_speed: {
      base: 80,
      increment: 10,
  ...
  o.hero = {
    ...
    speed: getStatValue(
      'hero_speed',
      horde.upgrades.upgrades['hero.speed'] ?? 1,
    ),
    hitPoints: getStatValue(
      'hero_health',
      horde.upgrades.upgrades['hero.health'] ?? 1,
    ),
    damage: 0,
    damageType: null,
    ...
    soundDies: 'hero_dies',
    weapons: [{ type: 'h_sword', count: null }],
    isMeatboy: false,
    bloodTimer: null,
    ...
    onKilled: function (attacker, engine) {
      ...
      for (var i = 0; i < num; ++i) {
        ...
        skull.position.y =
          this.position.y +
          this.size.height -
          horde.randomRange(0, this.size.height)
  ...
  o.h_sword = {
    ...
    cooldown: getStatValue(
      'h_sword_firingRate',
      horde.upgrades.upgrades['swordfiringRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_sword_speed',
      horde.upgrades.upgrades['sword.speed'] ?? 1,
    ),
    damage: getStatValue(
      'h_sword_damage',
      horde.upgrades.upgrades['sword.damage'] ?? 1,
    ),
    hitPoints: 1,
    spriteSheet: 'objects',
    spriteX: 64,
  ...
  o.h_knife = {
    ...
    cooldown: getStatValue(
      'h_knife_firingRate',
      horde.upgrades.upgrades['knife.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_knife_speed',
      horde.upgrades.upgrades['knife.speed'] ?? 1,
    ),
    hitPoints: 1,
    damage: getStatValue(
      'h_knife_damage',
      horde.upgrades.upgrades['knife.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 32,
    spriteY: 0,
  ...
  o.h_spear = {
    ...
    cooldown: getStatValue(
      'h_spear_firingRate',
      horde.upgrades.upgrades['spear.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_spear_speed',
      horde.upgrades.upgrades['spear.speed'] ?? 1,
    ),
    hitPoints: 1,
    damage: getStatValue(
      'h_spear_damage',
      horde.upgrades.upgrades['spear.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 96,
    spriteY: 0,
  ...
  o.h_fireball = {
    ...
    cooldown: getStatValue(
      'h_fireball_firingRate',
      horde.upgrades.upgrades['fireball.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_fireball_speed',
      horde.upgrades.upgrades['fireball.speed'] ?? 1,
    ),
    rotateSpeed: 500,
    hitPoints: 1,
    damage: getStatValue(
      'h_fireball_damage',
      horde.upgrades.upgrades['fireball.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 192,
    spriteY: 0,
...
*/
  ...
  o.h_axe = {
    ...
    cooldown: getStatValue(
      'h_axe_firingRate',
      horde.upgrades.upgrades['axe.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_axe_speed',
      horde.upgrades.upgrades['axe.speed'] ?? 1,
    ),
    hitPoints: 1,
    damage: getStatValue(
      'h_axe_damage',
      horde.upgrades.upgrades['axe.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 192,
    spriteY: 32,
  ...
  o.h_fire_sword = {
    ...
    cooldown: getStatValue(
      'h_fire_sword_firingRate',
      horde.upgrades.upgrades['fire_sword.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_fire_sword_speed',
      horde.upgrades.upgrades['fire_sword.speed'] ?? 1,
    ),
    hitPoints: 1,
    damage: getStatValue(
      'h_fire_sword_damage',
      horde.upgrades.upgrades['fire_sword.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 384,
    spriteY: 0,
  ...
  o.h_fire_knife = {
    ...
    cooldown: getStatValue(
      'h_fire_knife_firingRate',
      horde.upgrades.upgrades['fire_knife.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_fire_knife_speed',
      horde.upgrades.upgrades['fire_knife.speed'] ?? 1,
    ),
    hitPoints: 1,
    damage: getStatValue(
      'h_fire_knife_damage',
      horde.upgrades.upgrades['fire_knife.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 128,
    spriteY: 0,
  ...
  o.h_firebomb = {
    ...
    cooldown: getStatValue(
      'h_firebomb_firingRate',
      horde.upgrades.upgrades['firebomb.firingRate'] ?? 1,
    ),
    speed: getStatValue(
      'h_firebomb_speed',
      horde.upgrades.upgrades['firebomb.speed'] ?? 1,
    ),
    rotateSpeed: 300,
    hitPoints: 1,
    damage: getStatValue(
      'h_firebomb_damage',
      horde.upgrades.upgrades['firebomb.damage'] ?? 1,
    ),
    spriteSheet: 'objects',
    spriteX: 192,
    spriteY: 0,
...
*/
  ...
  var movementTypes = {
    ...
    wanderShoot: function (elapsed, engine) {
      ...
      if (
        !this.cooldown &&
        (diff.x < p.size.width / 2 || diff.y < p.size.height / 2)
      ) {
        this.chase(p)
        return 'shoot'
      } else {
  ...
  o.goblin = {
    ...
    weapons: [{ type: 'e_arrow', count: null }],
  ...
  o.demoblin = {
    ...
    moveChangeElapsed: 0,
    moveChangeDelay: 3000,
    weapons: [{ type: 'e_trident', count: null }],
  ...
  o.flaming_skull = {
    ...
    weapons: [{ type: 'e_static_blue_fire', count: null }],
  ...
  o.huge_skull = {
    ...
    weapons: [{ type: 'e_static_green_fire', count: null }],
  ...
  o.owlbear = {
    ...
    lootTable: [{ type: 'item_food', weight: 1 }],
    ...
    onUpdate: function (elapsed, engine) {
      ...
      switch (this.phase) {
        ...
        case 0:
          ...
          var ownerCenter = owner.position
            .clone()
            .add(horde.Vector2.fromSize(owner.size).scale(0.5))
  ...
  o.cube = {
	...
	*/
    lootTable: [{ type: 'item_gold_chest', weight: 1 }],
        ...
        case 1:
          if (!this.phaseInit) {
            ...
            engine.spawnObject(
              this,
              'e_bouncing_boulder',
              horde.Vector2.fromHeading(h - 0.3),
            )
            engine.spawnObject(
              this,
              'e_bouncing_boulder',
  ...
  o.imp = {
    ...
    onKilled: function (attacker, engine) {
      ...
      for (var x = 0; x < 2; ++x) {
        engine.spawnObject(this, 'dire_bat', horde.randomDirection(), false)
      }
    },
  ...
  o.wizard = {
    ...
    weapons: [{ type: 'e_shock_wave', count: null }],
  ...
  o.beholder = {
    ...
    lootTable: [{ type: 'item_weapon_fire_sword', weight: 1 }],
