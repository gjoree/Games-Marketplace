;(function define_horde_Object() {
  ...
  proto.die = function horde_Object_proto_die() {
    ...
    if (
      (this.role == 'monster' || this.role == 'projectile') &&
      !this.ignoreLogDeath
    )
      // Certain projectiles are ignored (ex. fire_sword_trail)
      this.logDeath()
  }
  ...
  proto.logDeath = function horde_Object_proto_logDeath() {
    ...
    if (this.achievementId !== null) {
      horde.Engine.prototype.getData(key, function (response) {
        ...
        if (
          _this.achievementId &&
          deaths >= _this.deathsForAchievement &&
          !horde.achievementsGranted[_this.achievementId]
        ) {
        ...
        case 'monster':
          if (this.hasState(horde.Object.states.DYING)) {
            return new horde.Vector2(
              (17 + this.deathFrameIndex) * this.size.width,
              this.spriteY,
            )
          }
          if (
          ...
          if (
            this.hasState(horde.Object.states.HURTING) &&
            this.size.width <= 32
          ) {
            return new horde.Vector2(16 * this.size.width, this.spriteY)
          }
          if (this.hasState(horde.Object.states.VICTORIOUS)) {
            return new horde.Vector2(20 * this.size.width, this.spriteY)
          }
          if (facingOverride) {
