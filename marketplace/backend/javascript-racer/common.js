...
//=========================================================================
async function fetchRacerUpgrades() {
  try {
    const response = await fetch('/api/racer/upgrades', {
      credentials: 'include',
    })
    const data = await response.json()
    if (!data.success) throw new Error('Failed to fetch upgrades')
...
var Game = {
  // a modified version of the game loop from my previous boulderdash game - see https://jakesgordon.com/writing/javascript-boulderdash/#gameloop
